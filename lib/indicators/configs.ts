    ...
    sources: [
      {
        ...
        role: "naaim_exposure",
        licenseNote:
          "NAAIM Exposure Index workbook is fetched from the public NAAIM page; public display policy remains review_required.",
        active: true,
      },
    ],
  },
    ...
    sources: [
      {
        ...
        role: "naaim_exposure",
        licenseNote:
          "Primary leg for NAAIM 4-week moving average, fetched from the public NAAIM workbook.",
        active: true,
      },
    ],
  },
