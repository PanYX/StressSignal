/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.typegen.jsonc --env-file=.env.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: c6ab534173ed46f7ba596a80d4dda30a)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	FRED_API_KEY: string;
	FRED_FETCH_TRANSPORT: string;
	CRON_SECRET: string;
	...
	WORKER_SELF_REFERENCE: Service<typeof import("./tests/fixtures/d1-worker").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./tests/fixtures/d1-worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FRED_API_KEY" | "FRED_FETCH_TRANSPORT" | "CRON_SECRET" | "GOOGLE_ADSENSE_PUBLISHER_ID" | "NEXT_PUBLIC_SITE_URL" | "SENTRY_DSN" | "NEXT_PUBLIC_PLAUSIBLE_DOMAIN" | "POSTHOG_KEY" | "BASIC_AUTH_USER" | "BASIC_AUTH_PASSWORD">> {}
}
